...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(Word_Inflector $singularizer, Word_Inflector $pluralizer)
    {
     ...
     */
    public function seems_utf8(string $string): bool
    {
    ...
    public function unaccent(string $string): string
    {
        ...
        return str_replace($double_chars['in'], $double_chars['out'], $string);
    }
    /**
